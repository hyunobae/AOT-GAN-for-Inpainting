...
class MaskGenerator():
    def __init__(self, height=960, width=544, channels=3, rand_seed=None, filepath=None):
...
img = np.zeros((544, 960, 3), np.uint8)
img = cv2.rectangle(img,(300,300), (500,500), (255,255,255), -1)
